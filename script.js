...
const galerias = {
    ...
    8: ['img/MR/MOMENROMANT (1).jpg',
        'img/MR/MOMENROMANT (1).MP4',
        'img/MR/MOMENROMANT (1).PNG',
        'img/MR/MOMENROMANT (2).JPG',
        'img/MR/MOMENROMANT (2).MP4',
        'img/MR/MOMENROMANT (3).JPG',
        'img/MR/MOMENROMANT (4).JPG',
        'img/MR/MOMENROMANT (5).JPG',
        'img/MR/WhatsApp Video 2026-04-04 at 2.10.19 AM.mp4',
        'img/MR/MOMENROMANT (6).JPG',
        'img/MR/MOMENROMANT (6).MP4',
        'img/MR/MOMENROMANT (7).MP4',
        'img/MR/MOMENROMANT (8).MP4',
        'img/MR/MOMENROMANT (9).MP4',
        'img/MR/MOMENROMANT (10).MP4',
        'img/MR/MOMENROMANT (11).MP4',
        'img/MR/MOMENROMANT (12).MP4',
        'img/MR/MOMENROMANT (13).MP4',
        'img/MR/MOMENROMANT (14).MP4',
        'img/MR/MOMENROMANT (3).MP4',
        'img/MR/MOMENROMANT (4).MP4',
    ],
    ...
    9: ['img/TU/TU (1).JPG',
        ...
        'img/TU/TU (3).PNG',
        'img/TU/TU (4).JPG',
        'img/TU/WhatsApp Video 2026-04-04 at 2.10.22 AM.mp4',
        'img/TU/TU (4).PNG',
        'img/TU/TU (5).JPG',
        'img/TU/TU (5).MP4',
        'img/TU/TU (5).PNG',
    ...
    10: ['img/TTK/TIKTK (1).MP4',
        ...
        'img/TTK/TIKTK (8).MP4',
        'img/TTK/TIKTK (9).MP4',
        'img/TTK/TIKTK (10).MP4',
        'img/TTK/TIKTK (11).MP4',
        'img/TTK/TIKTK (12).MP4',
        'img/TTK/TIKTK (13).MP4',
        'img/TTK/TIKTK (14).MP4',
        'img/TTK/TIKTK (15).MP4',
        'img/TTK/TIKTK (16).MP4',
        'img/TTK/TIKTK (17).MP4',
        'img/TTK/TIKTK (18).MP4',
        'img/TTK/TIKTK (19).MP4',
        'img/TTK/TIKTK (20).MP4',
        'img/TTK/TIKTK (21).MP4',
        'img/TTK/TIKTK (22).MP4',
        'img/TTK/TIKTK (23).MP4',
        'img/TTK/TIKTK (24).MP4',
        'img/TTK/TIKTK (25).MP4',
        'img/TTK/TIKTK (26).MP4',
        'img/TTK/TIKTK (27).MP4',
        'img/TTK/TIKTK (28).MP4',
        'img/TTK/TIKTK (29).MP4',
        'img/TTK/TIKTK (30).MP4',
        'img/TTK/TIKTK (31).MP4',
        'img/TTK/TIKTK (32).MP4',
        'img/TTK/TIKTK (33).MP4',
        'img/TTK/TIKTK (34).MP4',
        'img/TTK/TIKTK (35).MP4',
        'img/TTK/TIKTK (36).MP4',
        'img/TTK/TIKTK (37).MP4',
        'img/TTK/TIKTK (38).MP4',
        'img/TTK/TIKTK (39).MP4',
        'img/TTK/TIKTK (40).MP4',
        'img/TTK/TIKTK (41).MP4',
        'img/TTK/TIKTK (42).MP4',
        'img/TTK/TIKTK (43).MP4',
        'img/TTK/TIKTK (44).MP4',
        'img/TTK/TIKTK (45).MP4',
        'img/TTK/TIKTK (46).MP4',
        'img/TTK/TIKTK (47).MP4',
        'img/TTK/TIKTK (48).MP4',
        'img/TTK/TIKTK (49).MP4',
        'img/TTK/TIKTK (50).MP4',
        'img/TTK/TIKTK (51).MP4',
        'img/TTK/TIKTK (52).MP4',
        'img/TTK/TIKTK (53).MP4',
        'img/TTK/TIKTK (54).MP4',
        'img/TTK/TIKTK (55).MP4',
        'img/TTK/TIKTK (57).MP4',
        'img/TTK/TIKTK (56).MP4',
        'img/TTK/TIKTK (58).MP4',
        'img/TTK/TIKTK (59).MP4',
        'img/TTK/TIKTK (60).MP4',
        'img/TTK/TIKTK (61).MP4',
        'img/TTK/TIKTK (62).MP4',
        'img/TTK/TIKTK (63).MP4',
        'img/TTK/TIKTK (64).MP4',
        'img/TTK/TIKTK (65).MP4',
        'img/TTK/TIKTK (66).MP4',
        'img/TTK/TIKTK (67).MP4',
        'img/TTK/TIKTK (68).MP4',
        'img/TTK/TIKTK (69).MP4',
        'img/TTK/TIKTK (70).MP4',
        'img/TTK/TIKTK (71).MP4',
        'img/TTK/TIKTK (72).MP4',
        'img/TTK/TIKTK (73).MP4',
        'img/TTK/TIKTK (74).MP4',
        'img/TTK/TIKTK (75).MP4',
        'img/TTK/TIKTK (76).MP4',
        'img/TTK/TIKTK (77).MP4',
        'img/TTK/TIKTK (78).MP4',
        'img/TTK/TIKTK (79).MP4',
        'img/TTK/TIKTK (80).MP4',
        'img/TTK/TIKTK (81).MP4',
        'img/TTK/TIKTK (82).MP4',
        'img/TTK/TIKTK (83).MP4',
        'img/TTK/TIKTK (84).MP4',
        'img/TTK/TIKTK (85).MP4',
        'img/TTK/TIKTK (86).MP4',
        'img/TTK/TIKTK (87).MP4',
        'img/TTK/TIKTK (88).MP4',
        'img/TTK/TIKTK (89).MP4',
        'img/TTK/TIKTK (90).MP4',
        'img/TTK/TIKTK (91).MP4',
        'img/TTK/TIKTK (92).MP4',
        'img/TTK/TIKTK (93).MP4',
        'img/TTK/TIKTK (94).MP4',
        'img/TTK/TIKTK (95).MP4',
        'img/TTK/TIKTK (96).MP4',
        'img/TTK/TIKTK (97).MP4',
        'img/TTK/TIKTK (98).MP4',
        'img/TTK/TIKTK (99).MP4',
        'img/TTK/TIKTK (100).MP4',
        'img/TTK/TIKTK (101).MP4',
        'img/TTK/TIKTK (102).MP4',
        'img/TTK/TIKTK (103).MP4',
        'img/TTK/TIKTK (104).MP4',
        'img/TTK/TIKTK (105).mp4',
        'img/TTK/TIKTK (106).mp4',
        'img/TTK/TIKTK (107).mp4',
        'img/TTK/TIKTK (108).mp4',
        'img/TTK/TIKTK (109).MP4',
        'img/TTK/TIKTK (110).MP4',
        'img/TTK/TIKTK (111).MP4',
        '',
    ...
    12: [
        'img/VDN/VIDEOSNUESTR (1).mp4',
        'img/VDN/VIDEOSNUESTR (2).mp4',
        'img/VDN/VIDEOSNUESTR (3).MP4',
        'img/VDN/VIDEOSNUESTR (4).MP4',
        'img/VDN/VIDEOSNUESTR (5).MP4',
        'img/VDN/VIDEOSNUESTR (6).MP4',
        'img/VDN/VIDEOSNUESTR (7).MP4',
        'img/VDN/VIDEOSNUESTR (8).MP4',
        'img/VDN/VIDEOSNUESTR (9).MP4',
        'img/VDN/VIDEOSNUESTR (10).MP4',
        'img/VDN/VIDEOSNUESTR (11).MP4',
        'img/VDN/VIDEOSNUESTR (12).MP4',
        'img/VDN/VIDEOSNUESTR (13).MP4',
        'img/VDN/VIDEOSNUESTR (14).MP4',
        'img/VDN/VIDEOSNUESTR (15).MP4',
        'img/VDN/VIDEOSNUESTR (16).MP4',
        'img/VDN/VIDEOSNUESTR (17).MP4',
        'img/VDN/VIDEOSNUESTR (18).MP4',
        'img/VDN/VIDEOSNUESTR (19).MP4',
        'img/VDN/VIDEOSNUESTR (20).MP4',
        'img/VDN/VIDEOSNUESTR (21).MP4',
        'img/VDN/VIDEOSNUESTR (22).MP4',
        'img/VDN/VIDEOSNUESTR (23).MP4',
        'img/VDN/VIDEOSNUESTR (24).MP4',
        'img/VDN/VIDEOSNUESTR (25).MP4',
        'img/VDN/VIDEOSNUESTR (26).MP4',
        'img/VDN/VIDEOSNUESTR (27).MP4',
        'img/VDN/VIDEOSNUESTR (28).MP4',
        'img/VDN/VIDEOSNUESTR (29).MP4',
        'img/VDN/VIDEOSNUESTR (30).MP4',
        'img/VDN/VIDEOSNUESTR (31).mp4',
        'img/VDN/WhatsApp Video 2026-04-04 at 3.25.06 AM.mp4',

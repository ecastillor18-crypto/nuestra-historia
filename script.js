...
const galerias = {
    ...
    11: [
        ...
        'img/YO/5c598ef2-9fb8-4afe-91c6-d4a3bf6879cc.MP4',
        'img/YO/WhatsApp Video 2026-04-03 at 3.24.09 AM.mp4',

    ],
    12: [
         'img/VDN/VIDEOSNUEST (1).MP4',
         'img/VDN/VIDEOSNUEST (2).MP4',
         'img/VDN/VIDEOSNUEST (3).MP4',
         'img/VDN/VIDEOSNUEST (4).MP4',
         'img/VDN/VIDEOSNUEST (5).MP4',
         'img/VDN/VIDEOSNUEST (6).MP4',
         'img/VDN/VIDEOSNUEST (7).MP4',
         'img/VDN/VIDEOSNUEST (8).MP4',
         'img/VDN/VIDEOSNUEST (9).MP4',
         'img/VDN/VIDEOSNUEST (10).MP4',
         'img/VDN/VIDEOSNUEST (11).MP4',
         'img/VDN/VIDEOSNUEST (12).MP4',
         'img/VDN/VIDEOSNUEST (13).MP4',
         'img/VDN/VIDEOSNUEST (14).MP4',
         ...
         'img/VDN/VIDEOSNUEST (18).mp4',
         'img/VDN/VIDEOSNUEST (19).mp4',
         'img/VDN/VIDEOSNUEST (20).mp4',
         'img/VDN/VIDEOSNUEST (21).mp4',
         'img/VDN/VIDEOSNUEST (25).mp4',
         'img/VDN/VIDEOSNUEST (26).mp4',
         'img/VDN/VIDEOSNUEST (29).mp4',
         'img/VDN/VIDEOSNUEST (30).mp4',
         'img/VDN/VIDEOSNUEST (31).mp4',
         'img/VDN/VIDEOSNUEST (32).mp4',
         'img/VDN/VIDEOSNUEST (33).mp4',
